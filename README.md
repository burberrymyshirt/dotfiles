...
``` [shell]
sudo pacman -S --needed git stow nerd-fonts tmux zoxide keychain ripgrep fzf base-devel unzip wget curl neovim shotgun hacksaw xclip bash-completion go markdownlint
