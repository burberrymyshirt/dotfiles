...
``` [shell]
sudo pacman -S --needed jq git stow nerd-fonts tmux cargo zoxide keychain ripgrep fzf base-devel unzip wget curl shotgun hacksaw xclip bash-completion go markdownlint tree-sitter-cli brightnessctl
